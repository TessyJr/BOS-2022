...
<body>
    ...
    <div class="admin-participant flex flex-col gap-8 mx-12 my-14">
            ...
            <div class="flex justify-between items-center">
                ...
                <div class="flex gap-8">
                    ...
                    <div class="flex flex-col items-center">
                        <a href="{{route('adminPayment')}}" class="text-mainblue_dark text-xl font-semibold flex items-center">Payment</a>
        ...
        <section class="card flex flex-col gap-6">
                    ...
                    @foreach ($users as $i => $user)
                        <tr class="flex items-center text-center gap-4 py-4 px-8">
                            ...
                            <td class="flex justify-center content-center gap-2 w-52">
                                <a href="{{route('viewPaymentAdmin',['fn'=>$user->id])}}" target="_blank" rel="noopener noreferrer">
                                ...
                                <button><img src="{{ asset('assets/admin-payment/approve.svg') }}" alt="" class="h-8" id="verify-payment-btn" type="button" onclick="openVerifyModal({{$user->id}},'admin')"></button>
                                <button><img src="{{ asset('assets/admin-payment/disapprove.svg') }}" alt="" class="h-8" id="reject-payment-btn" type="button" onclick="openRejectModal({{$user->id}},'admin')"></button>

                                <button><img src="{{ asset('assets/icon/Admin/Delete.svg') }}" alt="" class="h-8" id="delete-payment-btn" type="button" onclick="openDeleteModal({{$user->id}},'admin')"></button>
                            </td>
            ...
            <form action="{{route('downloadPaymentData',['region'=>Auth::user()->campus_region])}}" method="GET">
                @csrf
                @method('GET')
