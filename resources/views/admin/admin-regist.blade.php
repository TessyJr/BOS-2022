...
<body>
    ...
    <div class="admin-participant flex flex-col gap-8 mx-12 my-14">
            ...
            <div class="flex justify-between items-center">
                ...
                <div class="flex gap-8">
                    ...
                    <div class="flex flex-col items-center">
                        <a href="{{route('viewMember')}}" class="text-mainblue_dark text-xl font-semibold flex items-center">Registration</a>
        ...
        <section class="card flex flex-col gap-6">
            ...
            <table class="flex flex-col overflow-y-scroll border-collapse h-full w-full font-poppins">
                <thead class="w-fit whitespace-nowrap">
                    <tr class="bg-mainblue text-white text-sm font-semibold flex items-center gap-4 py-4 px-8">
                        ...
                        <th scope="col" class="w-60">Email Binus</th>
                ...
                <tbody class="w-fit">
                    @foreach ($members as $i => $member)
                        <tr class="flex items-center text-center gap-4 py-4 px-8">
                            ...
                            <td class="text-sm font-medium w-60">{{$member->email_binus}}</td>
                            <td class="flex justify-center content-center gap-2 w-32">
                                <a href="{{route('viewAdminKTP',['fn'=>$member->id])}}" target="_blank" rel="noopener noreferrer">
                                    <button><img src="{{ asset('assets/icon/Admin/view.svg') }}" alt="View" class="h-8" type="submit"></button>
                                </a>
                                <a href="{{route('downloadKTP',['id'=>$member->id])}}"><img src="{{ asset('assets/icon/Admin/download.svg') }}" alt="View" class="h-8" type="button"></a>
                            </td>
                            <td class="flex justify-center content-center gap-2 w-32">
                                <a href="{{route('viewAdminFYP',['fn'=>$member->id])}}" target="_blank" rel="noopener noreferrer">
                                    <button><img src="{{ asset('assets/icon/Admin/view.svg') }}" alt="View" class="h-8" type="submit"></button>
                                </a>
                                <a href="{{route('downloadFYP',['id'=>$member->id])}}"><img src="{{ asset('assets/icon/Admin/download.svg') }}" alt="View" class="h-8" type="button"></a>
                            </td>
                            <td class="flex justify-center content-center gap-2 w-32">
                                <a href="{{route('viewAdminSurat',['fn'=>$member->id])}}" target="_blank" rel="noopener noreferrer">
                                    <button><img src="{{ asset('assets/icon/Admin/view.svg') }}" alt="View" class="h-8" type="submit"></button>
                                </a>
                                <a href="{{route('downloadSuratAdmin',['id'=>$member->id])}}"><img src="{{ asset('assets/icon/Admin/download.svg') }}" alt="View" class="h-8" type="button"></a>
                            </td>
                            <td class="text-sm font-medium w-40">{{$member->user->lnt_course}}</td>
            ...
            <form action="{{route('downloadMemberData',['region'=>Auth::user()->campus_region])}}" method="GET">
                @csrf
                @method('GET')
