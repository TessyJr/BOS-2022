...
<head>
    ...
    <link rel="stylesheet" href="{{ asset('css/admin-dashboard.css?t=220920222048') }}">
...
<body>
    ...
    <div class="admin-participant flex flex-col gap-8 mx-12 my-14">
            ...
            <div class="flex justify-between items-center">
                ...
                <div class="flex gap-8">
                    ...
                    <div class="flex flex-col items-center">
                        <a href="{{route('viewMember2Super')}}" class="text-mainblue_dark text-xl font-semibold flex items-center">Re-Registered</a>
        ...
        <section class="card flex flex-col gap-6">
            ...
            <table class="flex flex-col overflow-y-scroll border-collapse h-full w-full font-poppins">
                <thead class="w-fit whitespace-nowrap">
                    <tr class="bg-mainblue text-white text-sm font-semibold flex items-center gap-4 py-4 px-8">
                        ...
                        <th scope="col" class="w-80">Nama Lengkap</th>
                        <th scope="col" class="w-80">Linkedin URL</th>
                        <th scope="col" class="w-80">Github URL</th>
                        <th scope="col" class="w-80">LnT Course</th>
                    </tr>
                </thead>
                <tbody class="w-fit">
            ...
            <form action="{{$region != '' ? route('donwloadSuperMember2Data',['region'=>$region]) : route('donwloadSuperMember2Data',['region'=>$region2])}}" method="GET">
                @csrf
                @method('GET')
    ...
    <script src="{{ asset('js/admin-reregist.js?t=220920221319') }}"></script>
</body>
</html>
